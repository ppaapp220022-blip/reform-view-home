...
import {Check, Eye, EyeOff, X as XIcon} from 'lucide-react'
  ...
  return (
    <div className="mt-2">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <span className="text-[13px] text-[var(--color-text-hint)] text-right">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[13px] text-[var(--color-text-hint)] ml-auto">
          선택 포함
        </span>
      </label>
      ...
      <div className="px-4 py-3 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <label htmlFor="terms-service"
                 className="flex-1 cursor-pointer select-none text-[14px] text-[var(--color-text-sub)]">
          ...
          <button
            ...
            className="text-[13px] text-[var(--color-text-hint)] hover:text-[var(--color-accent)] underline underline-offset-2 transition-colors flex-shrink-0"
          >
            보기
          </button>
        </div>
...
function FieldLabel({htmlFor, children}: { htmlFor: string; children: React.ReactNode }) {
  return (
    <label
      htmlFor={htmlFor}
      className="block text-[13px] font-semibold tracking-wide uppercase mb-2"
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex flex-col gap-4 mb-5">
              ...
              <div>
                ...
                />
                {nickname && !isNicknameValid && (
                  <p className="mt-1.5 text-[13px]" style={{color: 'var(--color-error)'}}>
                    닉네임은 2~20자 사이로 입력해 주세요.
                  </p>
                )}
              </div>
            ...
            {serverError && (
              <div
                className="text-[14px] mb-4 px-4 py-3 rounded-[8px] flex items-start gap-2"
                style={{
