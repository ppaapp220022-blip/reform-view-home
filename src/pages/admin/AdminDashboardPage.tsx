...
const MOCK_REPORTS: ReportRow[] = [
  { id:1, reporterNickname:'soccer_fan99',  targetType:'POST',           reason:'FRAUD',         detail:'결제 후 연락 두절 의심',       status:'PENDING',  createdAt:'2026-05-09 14:32' },
  { id:2, reporterNickname:'kleague_lover', targetType:'POST',           reason:'FAKE',          detail:'가품으로 의심되는 유니폼',     status:'PENDING',  createdAt:'2026-05-09 11:15' },
  { id:3, reporterNickname:'barca_fan99',   targetType:'COMMUNITY_POST', reason:'INAPPROPRIATE', detail:'욕설 및 인신공격성 댓글 포함', status:'PENDING',  createdAt:'2026-05-09 09:04' },
  { id:4, reporterNickname:'hoops_seoul',   targetType:'POST',           reason:'FRAUD',         detail:'가격 부풀리기 의심',           status:'WARNING',  createdAt:'2026-05-08 17:20' },
  { id:5, reporterNickname:'volley_pro',    targetType:'POST',           reason:'FAKE',          detail:'동일 이미지 반복 게시',        status:'DELETED',  createdAt:'2026-05-08 10:00' },
]
...
const MOCK_MEMBERS: MemberRow[] = [
  { id:101, nickname:'jersey_master',  email:'jmaster@gmail.com',    status:'ACTIVE',    warningCount:0, tradeCount:47, joinedAt:'2026-05-09' },
  { id:102, nickname:'uniform_king',   email:'uking@naver.com',       status:'ACTIVE',    warningCount:0, tradeCount:32, joinedAt:'2026-05-08' },
  { id:103, nickname:'fraud_suspect',  email:'suspect@hotmail.com',   status:'SUSPENDED', warningCount:3, tradeCount:5,  joinedAt:'2026-05-07' },
  { id:104, nickname:'faker_fan',      email:'fakerfan@gmail.com',    status:'ACTIVE',    warningCount:1, tradeCount:12, joinedAt:'2026-05-06' },
  { id:105, nickname:'barca_fan99',    email:'barca99@kakao.com',     status:'ACTIVE',    warningCount:0, tradeCount:8,  joinedAt:'2026-05-05' },
]
...
const MOCK_TRADES: TradeRow[] = [
  { id:201, postTitle:'맨유 23/24 홈 어센틱',          buyerNickname:'jersey_master', sellerNickname:'uniform_king', price:78000,  status:'COMPLETED',    createdAt:'2026-05-09' },
  { id:202, postTitle:'바르셀로나 22/23 어웨이',        buyerNickname:'barca_fan99',   sellerNickname:'kleague_fan',  price:48000,  status:'IN_PROGRESS',  createdAt:'2026-05-09' },
  { id:203, postTitle:'전북 현대 2024 홈',              buyerNickname:'kleague_lover', sellerNickname:'kbo_master',   price:66000,  status:'DISPUTED',     createdAt:'2026-05-08' },
  { id:204, postTitle:'T1 2024 스프링 유니폼',          buyerNickname:'faker_fan',     sellerNickname:'esports_shop', price:85000,  status:'PAID',         createdAt:'2026-05-08' },
  { id:205, postTitle:'서울 SK 나이츠 23/24 홈',        buyerNickname:'hoops_seoul',   sellerNickname:'kbl_shop',     price:71000,  status:'CONFIRMED',    createdAt:'2026-05-07' },
]
                  ...
                  {MOCK_REPORTS.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 pr-3 whitespace-nowrap" style={{ color: 'var(--color-text-hint)', fontFamily: "'IAMAPLAYER',Giants,sans-serif", fontSize: 12 }}>
                          {r.createdAt.slice(5)}
                        </td>
                  ...
                  {MOCK_TRADES.map((t) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3 pr-3 font-medium" style={{ color: 'var(--color-primary)', fontFamily: "'IAMAPLAYER',Giants,sans-serif" }}>
                          {formatPrice(t.price)}
                        </td>
                        <td className="py-3">
                          <span
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                { to: '/admin/disputes/1',  icon: AlertOctagon, label: '분쟁 처리',          badge: '3', badgeColor: 'var(--color-warning)' },
