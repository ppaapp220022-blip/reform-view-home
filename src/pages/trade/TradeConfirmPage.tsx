          ...
          <div key={step.key} className="flex items-center flex-1">
            ...
            <div className="flex flex-col items-center flex-shrink-0" style={{ width: 56 }}>
              ...
              <span
                ...
                style={{ color: isCurrent ? 'var(--color-primary)' : isDone ? 'var(--color-success)' : 'var(--color-text-hint)', fontWeight: isCurrent ? 700 : 400 }}
              >
                {step.label}
              </span>
            </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="rounded-2xl p-5" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
            <div className="flex gap-4 mb-5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs mb-1" style={{ color: 'var(--color-text-hint)' }}>{trade.league} · {trade.team}</p>
                <p className="text-sm font-semibold leading-snug mb-1" style={{ color: 'var(--color-text-main)' }}>{trade.title}</p>
                <p className="text-lg font-bold" style={{ color: 'var(--color-primary)', fontFamily: "'IAMAPLAYER',Giants,sans-serif" }}>
                  {formatPrice(total)}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex justify-between text-xs">
                ...
                <span style={{ color: 'var(--color-primary)', fontFamily: "'IAMAPLAYER',Giants,sans-serif" }}>{trade.trackingNum}</span>
              </div>
            </div>
          </div>

          {/* 판매자 정보 */}
          <div className="rounded-2xl p-5 flex items-center gap-4" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
            <div
          ...
          {!confirmed && (
            <div className="flex flex-col gap-3">
              ...
              <button
                onClick={() => { if (!showWarning) { setShowWarning(true) } else { handleConfirm() } }}
                disabled={confirming}
